        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RentCostPerDay = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservationBikes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReservationBikes_Bikes_BikeId",
                        column: x => x.BikeId,
                        principalTable: "Bikes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReservationBikes_Reservations_ReservationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationBikes_BikeId",
                table: "ReservationBikes",
                column: "BikeId");

            migrationBuilder.CreateIndex(
                name: "IX_ReservationBikes_ReservationId",
                table: "ReservationBikes",
